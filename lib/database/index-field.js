...
IndexField.prototype = {
  ...
  hasAnyOption: function() {
    return !!this.domain.getConfiguration(this.getOptionKey('optionKeys'));
  },
  ...
  get hasDefaultValue() {
    return this.hasOption('defaultValue');
  },
  ...
  get facetEnabled() {
    ...
    return !!this.getOption('facetEnabled');
  },
  ...
  get resultEnabled() {
    ...
    return !!this.getOption('resultEnabled');
  },
  ...
  get searchEnabled() {
    ...
    return !!this.getOption('searchEnabled');
  },
